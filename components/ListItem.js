...
// export const ListItem = ({item, onNavigation}) => {
//     item.ListItem;
//     const onNavigation = id
//     return (
//         <View style={{...styles.container, backgroundColor:'yellow'}}>
//           <TouchableOpacity style={{ backgroundColor: 'gray', marginTop:10 ,width:'100%', height:120, flexDirection:'row', alignItems:'center'}} onPress={() => onNavigation()}>
